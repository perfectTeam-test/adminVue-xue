    ...
    <el-form ref="postForm" :model="postForm" :rules="rules" class="form-container">
      ...
      <sticky :class-name="'sub-navbar '+postForm.status">
        <template v-if="fetchSuccess">
          ...
          <router-link v-show="isEdit" :to="{ path:'create-form'}" style="margin-right:15px;">
          ...
          <el-dropdown trigger="click">
            ...
            <el-dropdown-menu slot="dropdown" class="no-padding">
              <el-dropdown-item>
                <el-radio-group v-model="postForm.comment_disabled" style="padding: 10px;">
          ...
          <el-dropdown trigger="click">
            ...
            <el-dropdown-menu slot="dropdown" class="no-padding no-border" style="width:300px">
              <el-form-item label-width="0px" style="margin-bottom: 0px" prop="source_uri">
                <el-input v-model="postForm.source_uri" placeholder="请输入内容">
                ...
                <el-col :span="8">
                  <el-tooltip class="item" effect="dark" content="将替换作者" placement="top">
                    <el-form-item label-width="50px" label="来源:" class="postInfo-container-item">
                      <el-input v-model="postForm.source_name" placeholder="将替换作者" style="min-width:150px;"/>
                    </el-form-item>
                  </el-tooltip>
                </el-col>
