  ...
  <div class="app-container">
    ...
    <el-form ref="formRecharge" :model="formRecharge" :inline="true" label-width="80px" class="demo-form-inline">
      ...
      <el-form-item label="充值金额">
        <el-input v-model="formRecharge.rechargeNumber"/>
      </el-form-item>
      <el-form-item>
  ...
  methods: {
    ...
    onSubmit() {
      const para = {
        ...
        'rechargeNumber': this.formRecharge.rechargeNumber,
        'envName': this.envName
      }

      if (!this.formRecharge.userNumber || !para.rechargeNumber || !para.envName) {
        this.$message({
          type: 'error',
          message: '填写数据不完整'
        })
